...
public class CuentaService {
	...
	public String getDatosCuenta(String cuenta) {
		// Variables
		String repo = "";
		Connection cn = null;
		String sql = "select monenombre, cuensaldo "
		...
		try {
			...
			ResultSet rs = pstm.executeQuery();
			if(rs.next()){
				String moneda = rs.getString("MONENOMBRE");
				double saldo = rs.getDouble("CUENSALDO");
				repo = moneda + "|" + saldo;
			}
			rs.close();
			pstm.close();
